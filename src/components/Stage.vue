<template>
  <div
    ...
    <div class="resp-iframe-wrapper">
      <iframe class="resp-iframe" src="https://www.youtube-nocookie.com/embed/VtgN1LnNw7k?controls=0&autoplay=1&loop=1&mute=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="curtains">
